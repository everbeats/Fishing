                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{action('ReelsController@edit', $row['reel_id'])}}" class="btn btn-primary">Edit</a>
                                    </td>
                                    <td>
                                        <form method="post" class="delete_form" action="{{action('ReelsController@destroy',$row['reel_id'])}}" >
                                            {{csrf_field()}}
