                            ...
                            <tbody>
                                ...
                                @foreach($hook as $row)
                                    <tr>
                                         ...
                                         <td><a href="{{action('HooksController@edit', $row['hook_id'])}}" class="btn btn-primary">Edit</a></td>
                                         <td>
                                             <form method="post" class="delete_form" action="{{action('HooksController@destroy',$row['hook_id'])}}" >
                                             {{csrf_field()}}
