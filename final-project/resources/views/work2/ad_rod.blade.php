                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$row['rod_price']}}</td>
                                    <td>
                                        <a href="{{action('RodsController@edit', $row['rod_id'])}}" class="btn btn-primary">Edit</a>
                                    </td>
                                    <td>
                                        <form method="post" class="delete_form" action="{{action('RodsController@destroy',$row['rod_id'])}}" >
                                        {{csrf_field()}}
